...
namespace KatlaSport.WebApi.Controllers
{
    ...
    public class HiveSectionsController : ApiController
    {
        ...
        [HttpPost]
        [Route("")]
        [SwaggerResponse(HttpStatusCode.Created, Description = "Create a new hive section")]
        ...
        public async Task<IHttpActionResult> AddHiveSection([FromBody] UpdateHiveSectionRequest createRequest)
        {
            ...
            var hiveSection = await _hiveSectionService.AddHiveSectionAsync(createRequest);
        ...
        [SwaggerResponse(HttpStatusCode.NotFound)]
        [SwaggerResponse(HttpStatusCode.InternalServerError)]
        public async Task<IHttpActionResult> SetHiveSectionStatus([FromUri] int hiveSectionId, [FromUri] bool deletedStatus)
        {
